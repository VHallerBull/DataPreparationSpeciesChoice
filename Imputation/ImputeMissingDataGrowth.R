...
SpeciesData<-readRDS(file = "~/SpeciesChoice/DataPreparationSpeciesChoice/DataDownload/GrowthBeforeImpute.RData")
...
png(file="Growth_Patternplot.png",width=1000)
...
for (i in 3:3){
  ...
  FileName <- paste('Growth_ImputedDatab_',i,'.RData',sep="")
