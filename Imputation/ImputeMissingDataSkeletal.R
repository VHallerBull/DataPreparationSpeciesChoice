...
SpeciesData<-readRDS(file = "~/SpeciesChoice/DataPreparationSpeciesChoice/DataDownload/SkeletalBeforeImpute.RData")
...
png(file="Skeletal_Patternplot.png",width=1000)
...
for (i in 1:3){
  ...
  FileName <- paste('Skeletal_ImputedDatab',i,'.RData',sep="")
...
for (i in 1:3){
  ...
  for (n in 1:numbersets){
    ...
    png(file=paste(DataName,"b_Pattern.png"))
