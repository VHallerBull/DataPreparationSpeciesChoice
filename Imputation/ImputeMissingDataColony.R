...
SpeciesData<-readRDS(file = "~/SpeciesChoice/DataPreparationSpeciesChoice/DataDownload/ColonyBeforeImpute.RData")
...
png(file="Colony_Patternplot.png",width=1000)
...
for (i in 1:3){
  ...
  FileName <- paste('Colony_ImputedData',i,'.RData',sep="")
