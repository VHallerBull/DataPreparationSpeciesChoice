...
data <- read.csv("https://coraltraits.org/traits/216.csv", as.is=TRUE)
data <- data[data$trait_id==216,]
...
SpeciesData$colonyfecundityMin <- TraitData$Min
SpeciesData$colonyfecundityMax <- TraitData$Max

#colony fecundity

data <- read.csv("https://coraltraits.org/traits/11.csv", as.is=TRUE)
data <- data[data$trait_id==11,]
...
SpeciesData$oocytesizeMin <- TraitData$Min
SpeciesData$oocytesizeMax <- TraitData$Max
...
SpeciesData$larvaldevelopment <- TraitData$Cat


#propagule size

data <- read.csv("https://coraltraits.org/traits/184.csv", as.is=TRUE)
data <- data[data$trait_id==184,]
...
SpeciesData$propagulesizeMin <- TraitData$Min
SpeciesData$propagulesizeMax <- TraitData$Max
...
SpeciesData$sexualsystem <- TraitData$Min


#symbiodinium
data <- read.csv("https://coraltraits.org/traits/3.csv", as.is=TRUE)
data <- data[data$trait_id==3,]
...
SpeciesData$symbiodinium <- TraitData$Min


#write.table(SpeciesData,"ReproductiveBeforeImpute.csv")
saveRDS(SpeciesData, file = "ReproductiveBeforeImpute.RData")
