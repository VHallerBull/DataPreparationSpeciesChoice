...
SpeciesData$coralliteMin <- TraitData$Min
SpeciesData$coralliteMax <- TraitData$Max


#polyps per area

data <- read.csv("https://coraltraits.org/traits/148.csv", as.is=TRUE)
data <- data[data$trait_id==148,]
...
SpeciesData$polypsareaMin <- TraitData$Min
SpeciesData$polypsareaMax <- TraitData$Max


#tissue thickness

data <- read.csv("https://coraltraits.org/traits/132.csv", as.is=TRUE)
data <- data[data$trait_id==132,]
...
SpeciesData$tissuethicknessMin <- TraitData$Min
SpeciesData$tissuethicknessMax <- TraitData$Max


#total biomass

data <- read.csv("https://coraltraits.org/traits/150.csv", as.is=TRUE)
data <- data[data$trait_id==150,]
...
SpeciesData$biomassMin <- TraitData$Min
SpeciesData$biomassMax <- TraitData$Max



#write.table(SpeciesData,"ReproductiveBeforeImpute.csv")
saveRDS(SpeciesData, file = "CoralliteBeforeImpute.RData")
